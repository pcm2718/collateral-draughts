...
state_load ( State * const state , FILE * loadfile )
{
   ...
   */
  fscanf ( loadfile , "%hu %hu" , &state->dim , &state->dim );

  /*
   * Read the current player.
   */
  fscanf ( loadfile , "%c" , &state->player );
...
state_save ( State * const state , FILE * savefile )
{
   ...
   */
  fprintf ( savefile , "%hu %hu" , state->dim , state->dim );

  /*
   * Write the current player.
   */
  fprintf ( savefile , "%c" , state->player );
